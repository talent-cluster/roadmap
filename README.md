...
Candidate data is typically retained for up to **24 months** unless you request earlier deletion.
---

### Do you share my data with third parties?
No and we never sell your data.

---

### Where is my data stored?
Your data is stored securely within the European Union (EU) and when data is transferred outside the EU, we ensure appropriate safeguards are in place.
...
By filling our [contact form](https://talent-cluster.com/contact). This will not affect the lawfulness of processing carried out before withdrawal.
